...
###v3.2.15  <span style="font-size: 16px;">2020/12/11</span>
##### Add:
1. 与君离别, 江湖再见
...
##### Improvements:
1. 完善`.gitignore`文件
2. [常用方法](../methods/methods.md)增加`xui.js`的图片描述
...
###v2.4.6  <span style="font-size: 16px;">2019/03/24</span>
##### Add：
1. 将组件细分，支持单个`import`啦，在`packages`里可以找到源代码，采用`es6`+`scss`编写
